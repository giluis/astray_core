use crate::{iter::TokenIter, base_traits::Parsable, error::parse_error::ParseError,token::Token, t};
...
impl Parsable<Token> for TestStruct {
    fn parse<'a>(iter: &mut TokenIter<Token>) -> Result<TestStruct, ParseError<TestStruct,Token>> {
